"""add cost measurement closed-loop tables

Revision ID: 20260713_0046
...
revision: str = "20260713_0046"
down_revision: Union[str, None] = "20260703_0045"
...
def downgrade() -> None:
    for table_name, indexes in (
        ("cost_measurement_events", (
            "ix_cost_measurement_events_measurement_created", "ix_cost_measurement_events_actor_user_id",
            "ix_cost_measurement_events_event_type", "ix_cost_measurement_events_line_id",
            "ix_cost_measurement_events_measurement_id", "ix_cost_measurement_events_id",
        )),
        ("cost_measurement_lines", (
            "ix_cost_measurement_lines_review", "ix_cost_measurement_lines_measurement_order",
            "ix_cost_measurement_lines_review_status", "ix_cost_measurement_lines_unit",
            "ix_cost_measurement_lines_item_name", "ix_cost_measurement_lines_section_name",
            "ix_cost_measurement_lines_source_row_index", "ix_cost_measurement_lines_source_sheet",
            "ix_cost_measurement_lines_quota_item_id", "ix_cost_measurement_lines_line_key",
            "ix_cost_measurement_lines_measurement_id", "ix_cost_measurement_lines_id",
        )),
        ("cost_measurements", (
            "ix_cost_measurements_status_updated", "ix_cost_measurements_locked_by", "ix_cost_measurements_updated_by",
            "ix_cost_measurements_created_by", "ix_cost_measurements_quota_version_id",
            "ix_cost_measurements_source_file_sha256", "ix_cost_measurements_status",
            "ix_cost_measurements_project_name", "ix_cost_measurements_name",
            "ix_cost_measurements_measurement_code", "ix_cost_measurements_measurement_uuid", "ix_cost_measurements_id",
        )),
    ):
