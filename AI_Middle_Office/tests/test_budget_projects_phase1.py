...
from app.services.budget_projects import MAX_IMPORT_BYTES, _guarded_sequence_columns
...
def test_import_rejects_empty_corrupt_oversized_and_sheet_dimension_limits(client):
    ...
    try:
        ...
        too_many_columns = _workbook_bytes([[f"列{index}" for index in range(1, 82)]], title="81列")
