...
def serialize_enterprise_quota_version(version: EnterpriseQuotaVersion | None) -> dict[str, Any] | None:
    ...
    return {
        ...
        "last_recalculated_at": _format_dt(version.last_recalculated_at),
    ...
    if keyword_text:
        ...
        query = query.filter(
            or_(
                ...
                EnterpriseQuotaComponent.specification.like(pattern),
                EnterpriseQuotaComponent.brand.like(pattern),
                EnterpriseQuotaItem.item_name.like(pattern),
                EnterpriseQuotaItem.quota_code.like(pattern),
            )
        )
    ...
    if keyword_text:
        ...
        query = query.filter(
            or_(
                ...
                EnterpriseCostResource.category.like(pattern),
                EnterpriseCostResource.specification.like(pattern),
                EnterpriseCostResource.brand.like(pattern),
...
def serialize_enterprise_quota_item(
    ...
    *,
    ...
    return {
        ...
        "formulas_json": item.formulas_json,
...
def serialize_enterprise_quota_component(
    ...
    return {
        ...
        "work_content": component.work_content,
        ...
        "formula_library_kind": component.formula_library_kind,
        "formula_link_status": component.formula_link_status,
        "formulas_json": component.formulas_json,
        "source_sheet": component.source_sheet,
        "source_row_index": component.source_row_index,
        "outline_level": component.outline_level,
...
def serialize_enterprise_cost_resource(resource: EnterpriseCostResource) -> dict[str, Any]:
    return {
        ...
        "formulas_json": resource.formulas_json,
