        ...
        suggestions.append(
            {
                ...
                "reference_source": getattr(cost_item, "reference_source", "cost_items.active"),
                "enterprise_quota_item_id": getattr(cost_item, "enterprise_quota_item_id", None),
                "enterprise_quota_version_code": getattr(cost_item, "enterprise_quota_version_code", None),
                "quota_code": getattr(cost_item, "quota_code", None),
                "unit": cost_item.unit,
