"""allow the API-13 upload-file removed outbox event
...
revision: str = "20260811_0088"
down_revision: Union[str, None] = "20260810_0087"
...
PREVIOUS_OUTBOX_EVENT_TYPES = tuple(
    ...
    if event_type != "bid.upload_file.removed.v1"
)
...
def downgrade() -> None:
    # MySQL deliberately rejects this downgrade while API-13 event rows still
