"""allow the API-12 upload-file received outbox event
...
down_revision: Union[str, None] = "20260810_0086"
...
PREVIOUS_OUTBOX_EVENT_TYPES = tuple(
    ...
    if event_type != "bid.upload_file.received.v1"
)
...
def downgrade() -> None:
    # MySQL deliberately rejects this downgrade while API-12 event rows still
