...
async def get_ops_logs(
    ...
    return api_ok(collect_error_logs(limit=limit))
...
async def get_ops_jobs(
    ...
    return api_ok(collect_job_status(db, stuck_minutes=stuck_minutes))
